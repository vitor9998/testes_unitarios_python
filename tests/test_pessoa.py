...
class TestPessoa(unittest.TestCase):
    def setUp(self):
        self.p1 = Pessoa('Paulo', 'Souza')
        self.p2 = Pessoa('Maria', 'Gomes')

    def test_pessoa_attr_nome_tem_o_valor_correto(self):
        self.assertEqual(self.p1.nome, 'Paulo')
    ...
    def test_pessoa_attr_sobrenome_tem_o_valor_correto(self):
        self.assertEqual(self.p1.sobrenome, 'Souza')
        self.assertEqual(self.p2.sobrenome, 'Gomes')
